...
const jobData = {
  ...
  prepareList: [
    ...
    { task: "Build a sample project using React and Node.js", completed: false },
    { task: "Practice system design questions", completed: false },
  ],
  testsToTake: [
    { name: "React", description: "Test your knowledge of React components, hooks, and state management." },
    { name: "NodeJS", description: "Assess your understanding of server-side JavaScript and Node.js ecosystem." },
    { name: "MongoDB", description: "Evaluate your skills in working with NoSQL databases and MongoDB queries." },
    { name: "Express", description: "Test your ability to build RESTful APIs using Express.js framework." },
  ],
  skills: {
    React: 0.8,
    PostgreSQL: 0.6,
            ...
            <Accordion type="single" collapsible className="w-full">
              {jobData.testsToTake.map((test) => (
                <AccordionItem value={test.name} key={test.name}>
                  <AccordionTrigger>
                    <Badge
                      variant={selectedSkill === test.name ? "default" : "secondary"}
        ...
        <div className="space-y-8">
            ...
            <ul className="space-y-2">
              {prepareList.map((item, index) => (
                <li key={index} className="flex items-center space-x-2">
                  <Checkbox checked={item.completed} onCheckedChange={() => toggleTask(index)} />
          ...
          <Card className="p-4">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-medium">Readiness: {jobData.readiness}%</h3>
              <Dialog>
                ...
                <DialogContent className="sm:max-w-[425px]">
                  <DialogHeader>
                    ...
                    <DialogDescription>Detailed view of your skills for this job.</DialogDescription>
                  </DialogHeader>
                  <div className="py-4">
